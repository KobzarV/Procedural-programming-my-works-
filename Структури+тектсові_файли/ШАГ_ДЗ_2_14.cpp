...
void Show_file_books(book x[], int size, FILE *pfile)  // функція виводу книг, які збережені у файлі
{
...
(ДЗ, выданное 7 ноября) добавить возможность считывания данных для массива структур из файла 
и возможность записи в файл массива структур.
 Работать с файлами в текстовом режиме */



    /*(Так як ми працюємо з текстовим файлом) На мою думку можна залишити основну роботу по зміні даних в структурі в консолі,
    а у файл просто записувати результат. Потрібно буде змінювати вивід елементів і буде важко зчитувати з текстового файлу поля структури
    для подальшої обробки. Тому після кожної зміни в даних необхідно буде їх зберігати.*/
    ...
    do
    {
        ...
        cout << "2) Вивести на екран книги з файлу library.txt" << endl;
        cout << "3) Редактувати книгу" << endl;
        cout << "4) Пошук книги за автором" << endl;
        cout << "5) Пошук книги за назвою" << endl;
        cout << "6) Сортування книг за назвою" << endl;
        cout << "7) Сортування книг за автором" << endl;
        cout << "8) Сортування книг за видавництвом" << endl;
        cout << "9) Зберегти дані у файл library.txt" << endl;
        cout << "0) Exit" << endl;
